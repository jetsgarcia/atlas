...
import AddModuleButton from "@/app/(routes)/admin/manage-courses/[afosCode]/_components/add-module-button";
import PageTitle from "@/components/page-title";
import EmptyPlaceholder from "@/components/empty-placeholder";
import { DataTable } from "@/app/(routes)/admin/manage-courses/[afosCode]/_components/data-table";
import {
  Module,
  columns,
} from "@/app/(routes)/admin/manage-courses/[afosCode]/_components/columns";
